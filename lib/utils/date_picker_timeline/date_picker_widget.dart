...
import 'package:project_flutter/utils/date_picker_timeline/date_widget.dart';
import 'package:project_flutter/utils/date_picker_timeline/extra/color.dart';
import 'package:project_flutter/utils/date_picker_timeline/extra/style.dart';
import 'package:project_flutter/utils/date_picker_timeline/gestures/tap.dart';
...
class DatePicker extends StatefulWidget {
  ...
  /// TextStyle for today Value
  final TextStyle todayTextStyle;

  /// TextStyle for today Value
  final TextStyle selectedDateStyleIsToday;
  ...
  DatePicker(
    ...
    this.todayTextStyle = defaultTodayTextStyle,
    this.selectedDateStyleIsToday = defaultTodayTextStyleIsSelected,
...
class _DatePickerState extends State<DatePicker> {
  ...
  Widget build(BuildContext context) {
    // if(widget.isSetDate == true){
    //   widget.isSetDate = false;
    //   _currentDate = widget.initialSelectedDate;
    // }
    return Container(
          ...
          return DateWidget(
            ...
            dayTextStyle: isDeactivated
                ...
                : isSelected
                    ? widget.dayTextStyle
                    : widget.dayTextStyle,
            selectedDateStyleIsToday:isSelected && _currentDate!.day == DateTime.now().day ? widget.selectedDateStyleIsToday : null,
            width: widget.width,
